...
function paina(e) {
  if(!e.target.classList.contains("tiedot")) return;
  if(e.buttons == 1) {
...
function liikuta(e) {
  ...
  function laske(i) {
    ...
    let num = pohja.children[nykyY / 50 + i].textContent;
    pohja.children[nykyY / 50 + i].textContent = kohde.textContent;
